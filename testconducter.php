...
<html>
  ...
  <body >
      ...
      <div id="container">
      <div class="header">
                <img style="margin:10px 2px 2px 10px;float:left;" height="52" width="362" src="images/logo.png" alt="Studyskill"/>
            </div>
           <form id="testconducter" action="testconducter.php" method="post">
          <div class="menubar" style="text-align:center;">
              <h2 style="font-family:helvetica,sans-serif;font-weight:bolder;font-size:120%;color:#f50000;padding-top:0.3em;letter-spacing:1px;">Studyskill:Test Conducter</h2>
          </div>
      <div class="page">
          <?php
     ...
     <div id="footer">
          <p style="font-size:70%;color:#ffffff;"> Developed By-<b>Team</b></p>
      </div>
      </div>
  </body>
</html>
