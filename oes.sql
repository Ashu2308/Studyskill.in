...
--
-- Host: localhost
-- Generation Time: Nov 29, 2016 at 06:37 PM
...
-- Database: `oes`
--
CREATE DATABASE IF NOT EXISTS `oes` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `oes`;
...
(1, 'Upendra', 'ùip:z', 'ashu23081991@gmail.com', '9555961448', 'New Delhi', 'Delhi', '110096');
...
(1, 'first', 'first test', '2016-11-28', '23:07:30', 1, '2016-11-29 12:07:30', '2016-12-16 18:29:59', 2, 2, 0, 'äRDàá', NULL);
